  ...
  return (
    <motion.section 
        ...
        <p className='text-lg'>
            ...
            J'utilise principalement <span className="font-semibold">React, Next.js, Node.js, et MongoDB</span> pour me spécialiser dans le <span className="font-medium">développement front-end</span> mais je suis également familier avec bien d'autres langages.
        </p>
        <p className="text-lg">
